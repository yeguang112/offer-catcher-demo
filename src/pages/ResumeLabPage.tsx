    ...
    <main>
      <section className="section page-hero results-hero">
        <div className="page-hero-copy">
          <span className="section-kicker"><ShinyText text="简历实验室" /></span>
          <h1><DecryptedText text="先把简历改到像这个岗位的人，再去投递。" revealDirection="center" /></h1>
          <p>
      ...
      <section className="section">
        <div className="section-heading">
          <div>
            <span className="section-kicker"><ShinyText text="一周陪跑计划" speed={4.1} /></span>
